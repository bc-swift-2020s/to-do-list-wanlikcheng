...
class ToDoDetailTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // hide keyboard if tap out of field
    ...
    func updateUserInterface() {
        ...
        enableDisableButton(text: nameField.text!)
        updateReminderSwitch()
    }
        ...
        LocalNotificationManager.isAuthorized { (authorized) in
            DispatchQueue.main.async {
                if authorized == false && self.reminderSwitch.isOn {
                    self.oneButtonAlert(title: "User Has Not Allowed Notifications", message: "to receieve alerts for reminders, open the Settings app, select To Do List > Notifications > Allow Notifications")
